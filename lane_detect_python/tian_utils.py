...
def post_process_on_bev(prediction_binary_img,origin_img,M,M_inv):    
    ...
    cv2.imwrite('prediction_binary_on_origin.png',prediction_binary_img)
    ...
    try:
        ...
        if NEED_VISUALIZATION:
            ...
            cv2.imwrite("tian_line_img.png", line_img) 
            ...
            cv2.imwrite('prediction_linefit_on_binary_front.png',fit_on_front_img)
